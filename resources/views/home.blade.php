      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0">
            <h3>Selamat Bergabung Di Sekoah Kami</h3>
            <p>
            Mewujudkan pelajar yang berprestasi, berpendidikan karakter, memiliki sopan santun, dan lulusan siap kerja.
            </p>
            <div class="row">
              <div class="col-md-6">
    ...
    <section id="counts" class="counts section-bg">
      <div class="container">
        ...
        <div class="row counters">
          ...
          <div class="col-lg-3 col-6 text-center">
            <span data-purecounter-start="0" data-purecounter-end="1189" data-purecounter-duration="1" class="purecounter"></span>
            <p><B>Murid</B></p>
          </div>
